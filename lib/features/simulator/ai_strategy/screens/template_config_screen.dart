// lib/features/simulator/ai_strategy/screens/template_config_screen.dart
...
class _TemplateConfigScreenState extends State<TemplateConfigScreen> {
  ...
  void _validate() async {
    ...
    if (!canGenerate) {
      if (mounted) {
        _showUpgradeDialog(
            'You\'ve used your 3 free AI strategies today. Upgrade to Premium for unlimited generation.');
      }
      return;
    }
