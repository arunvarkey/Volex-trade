...
/// Represents a trading strategy generated by AI.
///
...
class AiStrategyError implements Exception {
  final AiErrorType type;
  final String message;
  final String? originalError;

  const AiStrategyError(this.type, this.message, {this.originalError});

  @override
  String toString() => 'AiStrategyError($type): $message';
}
