...
// in volex_terminal/test/unit/ai_strategy/ai_service_test.dart.
...
import 'package:volex_terminal/core/services/secure_key_storage.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSecureKeyStorage extends _i1.Mock implements _i7.SecureKeyStorage {
  MockSecureKeyStorage() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> storeApiKey(String? key) => (super.noSuchMethod(
        Invocation.method(
          #storeApiKey,
          [key],
        ),
